...
if sys.platform[:3] == "win":  # pragma: no cover
    os.environ['PATH']=os.path.join(os.getcwd(), "Tesseract-OCR")+";"+os.environ['PATH']
    os.environ['TESSDATA_PREFIX']=os.path.join(os.getcwd(), "Tesseract-OCR\\tessdata")
    TESSDATA_PREFIX = os.getenv('TESSDATA_PREFIX', None)
