...
class MainView(BaseView):
	def __init__(self):
		...
		creator=views.ViewCreator.ViewCreator(1,self.hPanel,self.creator.GetSizer(),wx.HORIZONTAL)
		vCreator=views.ViewCreator.ViewCreator(1,self.hPanel,creator.GetSizer(),wx.VERTICAL)
		...
		vCreator=views.ViewCreator.ViewCreator(1,self.hPanel,creator.GetSizer(),wx.VERTICAL,20)
		self.open = vCreator.button(_("追加"), self.events.open)
		self.delete = vCreator.button(_("削除"), self.events.delete)
		creator=views.ViewCreator.ViewCreator(1,self.hPanel,self.creator.GetSizer(),views.ViewCreator.FlexGridSizer,10)
		...
		creator=views.ViewCreator.ViewCreator(1,self.hPanel,self.creator.GetSizer(),wx.HORIZONTAL,20,style=wx.ALIGN_RIGHT)
